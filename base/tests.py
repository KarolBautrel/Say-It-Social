...
class RoomManagementTestCase(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create(username='lauren',email='lauren@lauren.com',password = 'secret')
        self.user2 = User.objects.create(username='olivia',email='olivia@olivia.com',password = 'secret')
